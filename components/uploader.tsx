      ...
      <div>
        <div className="space-y-1 mb-4">
          ...
          <p className="text-sm text-gray-500">
            Accepted formats: .pdf, .png, .jpg, .gif, .mp4
          </p>
        </div>
        <label
        ...
        >
          ...
          {data.image && file?.type.startsWith("image/") && (
          ...
          {data.image && file?.type === "application/pdf" && (
            <Document
              file={data.image}
              className="h-full w-full rounded-md object-contain overflow-hidden"
            >
              {/* @ts-ignore */}
